        ...
        <div className="text-center space-y-6">
          ...
          <div className="space-y-4 sm:space-y-6 mt-6 sm:mt-8">
            <div className="flex flex-col items-center gap-4">
              {/* Open to Work Badge */}
              <div className="flex items-center gap-2 bg-green-900/30 border border-green-500/40 rounded-full px-4 py-2 backdrop-blur-sm">
              ...
              <p className="text-base sm:text-lg text-gray-400 max-w-2xl px-4 sm:px-0">
                Full-time freelancer crafting impactful digital experiences that prioritize user
                satisfaction and seamless functionality
              </p>
            </div>
            {/* Tech Stack Pills */}
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4 mt-8 sm:mt-12 px-4 sm:px-0">
            ...
            <a
              ...
              className="px-6 sm:px-8 py-3 bg-[#21262D] rounded-full hover:bg-[#2D333B] transition-colors border border-[#2D333B] hover:border-gray-600 text-center inline-flex items-center justify-center gap-2"
            >
          ...
          <div className="flex justify-center gap-4 sm:gap-6 mt-8 sm:mt-12">
            {[
              { name: "GitHub", icon: "💻", href: "https://github.com/samney" },
              {
                name: "LinkedIn",
                icon: "💼",
                href: "https://www.linkedin.com/in/mneys/",
