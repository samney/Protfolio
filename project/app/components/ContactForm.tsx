        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              rows={6}
              className={inputStyles}
              placeholder="Tell me about your project, idea, or just say hello. I'm always excited to connect with fellow creatives and potential collaborators!"
            />
          </div>
          ...
          {submitStatus === 'error' && (
            <div className="bg-red-900/30 border border-red-500/40 rounded-lg p-4 text-red-300">
              ❌ Failed to send message. Please try again or contact me directly at saad.mney1@gmail.com
            </div>
          )}
